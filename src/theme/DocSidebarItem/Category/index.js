 ...
 *
 * Swizzled from Docusaurus 3.10.2. We retain the upstream behavior except
 * that only level-two topics auto-collapse their siblings. Level-one groups
 * stay open so readers can always see the Ambassador guide's main sections.
 */
...
function DocSidebarItemCategoryCollapsible({
  ...
  const autoCollapseThisLevel = autoCollapseCategories || level === 2;
